...
En este caso la conexión con GitHub la realizé al hacer `git commit` después de solucionar el error para sincronizar la información que tenía en el repositorio local con el remoto.